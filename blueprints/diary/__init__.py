...
from .delete import delete_diary_dp, delete_all_diaries_dp, delete_diary_login_data_dp
...
diary_dp.register_blueprint(delete_diary_login_data_dp, url_prefix='/delete-login-data')
diary_dp.register_blueprint(delete_all_diaries_dp, url_prefix='/delete-all')
